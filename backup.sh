...
tar -czf - /tmp/db.sqlite3 /data/attachments /data/config.json 2>/dev/null | openssl enc -e -aes256 -salt -pbkdf2 -pass pass:"${BACKUP_ENCRYPTION_KEY}" -out "/tmp/${BACKUP_FILE}.tar.gz"
